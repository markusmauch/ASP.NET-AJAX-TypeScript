...
{
	/**
	 * Manages the flow of the Web requests issued by the {@link Sys.Net.WebRequest} object to the associated executor object.
	...
	class _WebRequestManager
	{
		...
		/**
		 * Gets or sets the time-out for the default network executor.
		 * @throws {@link Sys.ArgumentOutOfRangeException} An invalid parameter was passed.
		 * @param value
		 ...
		 * @param webRequest
		 * 		An instance of the {@link Sys.Net.WebRequest} class.
		 */
