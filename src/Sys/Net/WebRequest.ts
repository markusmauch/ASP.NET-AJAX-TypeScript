module Sys.Net
{
    ...
    export class WebRequest
	{
		...
		/**
		 * Gets the URL of the {@link Sys.Net.WebRequest} instance.
		 * @returns
		...
		/**
		 * Sets the URL of the {@link Sys.Net.WebRequest} instance.
		 * @param value
		 * 		A string that represents the URL that the Web request is directed to. 
		 */
		...
		/**
		 * Gets or sets the HTTP verb that was used by the {@link Sys.Net.WebRequest} class to issue the Web request. 
		 * @returns
		...
		/**
		 * Sets the HTTP verb that was used by the {@link Sys.Net.WebRequest} class to issue the Web request. 
		 * @param value
		 * 		A string that contains the HTTP verb for the Web request. value must be an HTTP verb that is recognized by the Web server, such as "GET" or "POST". 
		 */
        ...
        /**
		 * Gets the HTTP body of the Sys.Net.WebRequest instance.
		 * @returns
		...
		/**
		 * Sets the HTTP body of the Sys.Net.WebRequest instance.
		 * @param value
		 * 		The HTTP body to assign to the Web request.
		 */
		...
		/**
		 * Gets the user context associated with the Sys.Net.WebRequest instance.
		 * @returns
		...
		/**
		 * Sets the user context associated with the Sys.Net.WebRequest instance.
		 * @param value
		 * 		The user context information that is associated with the request. value can be null or any primitive type or JavaScript object. 
		 */
		...
		/**
		 * Gets the executor of the associated Sys.Net.WebRequest instance.
		 * @returns
		 * 		An instance of a class that is derived from {@link Sys.Net.WebRequestExecutor}.
		 */
		public get_executor()
		{
		...
		/**
		 * Sets the executor of the associated Sys.Net.WebRequest instance.
		 * @param value
		 * 		An instance of a class that is derived from {@link Sys.Net.WebRequestExecutor}. 
		 */
		...
		/**
		 * Sets the time-out value for the Sys.Net.WebRequest instance.
		 * @param value
		 * 		The time interval in milliseconds.
		 */
		...
		/**
		 * Gets the resolved URL of the {@link Sys.Net.WebRequest} instance.
		 * @returns
		 * 		A string that represents the URL that the Web request is directed to. 
		 */
